...
if (!$modificar) {
	...
	$mensaje = '
		...
		<p>&nbsp;&nbsp;&nbsp;&nbsp;Bienvenido a la comunidad <strong>Conexi&oacute;n Reciclado</strong>.
		Ya se encuentra habilitado para comprar y vender.</p>
	';
	...
	sleep(5);
        ...
        //MAIL PARA EL ADMIN
        //mensaje
        $mensaje = '<p>'.htmlentities($_POST['nombre']).' '.htmlentities($_POST['apellido']).' se sum&oacute; a la comunidad de <strong>Conexi&oacute;n Reciclado</strong></p>';
	...
	$mailTemplate = str_replace('<!--{asunto}-->', $subject, $mailTemplate);
        //instaciacion de la clase mailer
        $mail = new ConexionMailer();
	$mail->AddAddress('info@conexionreciclado.com.ar');
