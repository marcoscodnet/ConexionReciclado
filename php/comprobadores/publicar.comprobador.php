...
if (!$_POST['titulo'] || !$_POST['cantidadValor'] || !$_POST['descripcion'] === '') {
...
if (!Validador::validarNumero($_POST['cantidadValor']) || (!$_POST['sugerenciaPrecio']=='' && !Validador::validarPrecio($_POST['sugerenciaPrecio']))) {
	echo ($validacionError);
	exit();
}
