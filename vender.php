...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'publicar', 'jquery.colorbox', 'loginRegister', 'selectCategorias', 'selectProvincias', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery-ui.min', 'jquery.tmpl.min', 'jquery.iframe-transport', 'jquery.fileupload', 'jquery.fileupload-ui', 'application', 'validacionVender', 'validadores', 'newsletter'), $html);
...
<body>
    ...
    <?php
    	$html = Archivo::leer('tpl/contenidoVender.php');
