...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'listarProductos', 'selectCategorias', 'selectProvincias', 'loginRegister', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery.colorbox', 'loginRegister', 'galleryBox', 'compartir', 'validadores', 'newsletter', 'seguir'), $html);
